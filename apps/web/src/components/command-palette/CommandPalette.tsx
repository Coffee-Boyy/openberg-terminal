...
export function CommandPalette({ open, onClose, onSelect, defaultTicker }: CommandPaletteProps) {
  ...
  return (
    <>
      {/* Backdrop — sits at z-50, click closes palette */}
      <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm" onClick={onClose} />
      {/* Card — z-55, above backdrop so pointer events land on buttons */}
      <div data-testid="command-palette" className="fixed inset-0 z-55 flex items-start justify-center pt-20">
        <div
